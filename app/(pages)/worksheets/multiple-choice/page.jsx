  ...
  return (
      <div className="pb-16">
        <div className="py-16 px-5 md:px-12 bg-gray-100 border-b-2 border-gray-200">
          <h1 className="text-3xl mb-10 text-center font-semibold">Create a Multiple Choice Worksheet</h1>
        ...
        <div>
          ...
          <div ref={contentToPrint} className="h-[1056px] w-[816px] max-w-[100%] mx-auto border-2 border-gray-300 shadow-lg p-6 relative">
              ...
              <h2 className="text-center text-4xl font-semibold pt-10 mb-4">Multiple Choice Worksheet</h2>
